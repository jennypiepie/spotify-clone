import { ArrowsRightLeftIcon, BackwardIcon,PlayIcon,PauseIcon,ForwardIcon,ArrowPathRoundedSquareIcon,SpeakerWaveIcon} from "@heroicons/react/24/solid"
  ...
  return (
      <div className='h-24 bg-gradient-to-b from-black to-gray-900 grid grid-cols-3 text-xs md:text-base px-2 md:px-8'>
              ...
              {selectedSong && (
                  <>
                      <div className='hidden md:block'>
                          <Image src={selectedSong.album.images[0].url}
                            alt={`Album cover for ${selectedSong.name}`} height={40} width={40} />
                      </div>
                      <div>
          ...
          <div className='flex justify-evenly items-center'>
              ...
              {
                  isPlaying ? <PauseIcon className='icon-playback' onClick={handlePlayPause}/> :
